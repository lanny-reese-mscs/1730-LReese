...
namespace LReeseEx2E
{
    public partial class Form1 : Form
    {
        ...
        private void buttonCalc_Click(object sender, EventArgs e)
        {
            ...
            //    ).ToString();
            //sideffect03TextBox.Text = counter.ToString();
            result03TextBox.Text = (
            ...
            //        isValid == true & counter++ < years
            //    ).ToString();
            //sideffect04TextBox.Text = counter.ToString();
            result04TextBox.Text = (
            ...
            //        isValid == true || counter++ < years
            //    ).ToString();
            //sideffect05TextBox.Text = counter.ToString();
            result05TextBox.Text = (
            ...
            //        isValid == true | counter++ < years
            //    ).ToString();
            //sideffect06TextBox.Text = counter.ToString();
            result06TextBox.Text = (
            ...
            //        !(counter++ >= years)
            //    ).ToString();
            //sideffect09TextBox.Text = counter.ToString();
            result09TextBox.Text = (
